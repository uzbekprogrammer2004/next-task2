...
//     (total, product) => total + product.count * product.summa,
//     0
//   );
...
//               ))}
//             </div>
//             <h3 className="pt-4 pb-4 w-[400xp] text-blue-500 cursor-pointer ">Все информация о доставке</h3>

...
const Index = () => {
  return (
    ...
    <main className="bg-[#f2f2f2] pt-7 pb-9">
      <div className="mx-[20px] lg:mx-[138px]">
        ...
        <div className="flex flex-col lg:flex-row gap-[24px]">
          <div className="flex flex-col justify-between w-full rounded-lg h-auto lg:h-[417px] bg-white text-black pt-[38px] pl-[35px] pb-[45px]">
            <div>
              <h2 className="text-[#1e1c14] text-[24px] lg:text-[32px] font-[700] font-[Fira Sans] w-full lg:w-[462px]">
      ...
      <div className="mx-[5%] md:mx-[138px]">
        ...
        <div className="w-full h-auto rounded-md pt-[20px] md:pt-[70px] pl-[10px] md:pl-[80px] pb-[80px] pr-[100px] bg-black">
          <div className="space-y-4">
            ...
            <span className="text-white text-base md:text-xl font-normal font-['SF Pro Display'] leading-6 md:leading-7 block">
              предлагает широкий ассортимент продукции с доставкой по Ташкенту, области и другим регионам Узбекистана. Ведется работа как с розничными покупателями, так и с оптовыми клиентами. Разнообразие форм оплаты заметно упрощает процесс приобретения товара. Действует гибкая система скидок. Разнообразие форм оплаты заметно упрощает процесс приобретения товара. Действует гибкая система скидок.
            </span>
          </div>
        </div>
      </div>
      <div className="mx-[20px] lg:mx-[138px] mt-[40px] lg:mt-[80px]">
        <Carousel autoplay className='w-full h-154px ' >
          <div className="flex justify-center items-center h-48 bg-white rounded-lg p-4">
            <Image src={PumaLogo} alt="Puma Logo" className="h-24" />
          </div>
          <div className="flex justify-center items-center h-48 bg-white rounded-lg p-4">
            <Image src={UnderArmourLogo} alt="Under Armour Logo" className="h-24" />
          </div>
          <div className="flex justify-center items-center h-48 bg-white rounded-lg p-4">
            <Image src={NikeLogo} alt="Nike Logo" className="h-24" />
          </div>
          <div className="flex justify-center items-center h-48 bg-white rounded-lg p-4">
            <Image src={AdidasLogo} alt="Adidas Logo" className="h-24" />
          </div>
          <div className="flex justify-center items-center h-48 bg-white rounded-lg p-4">
            <Image src={ReebokLogo} alt="Reebok Logo" className="h-24" />
          </div>
        </Carousel>
      </div>
    </main>
...
// const benefits = [
//   {
//     icon: <TruckOutlined className="text-[50px] transform -scale-x-100" />,
//     text: "Доставка по всему Узбекистану",
//   },
//   {
//     icon: <PercentageOutlined className="text-[40px]" />,
//     text: "Скидки и акции",
//   },
//   {
//     icon: <FileTextOutlined className="text-[40px]" />,
...
//               <Image src={CaruselImg} alt={`Image ${index + 1}`} layout="fill" objectFit="cover" />
//             </div>
//           ))}
//         </Carousel>
//       </div>
...
//               <div key={index} className="w-full lg:w-[287px] h-auto lg:h-[289px] bg-white rounded-lg flex flex-col items-center pt-[72px] pb-[30px]">
//                 <div className="w-[26px] h-[26px] bg-[#fbd029] rounded-[5px] mb-[-20px]"></div>
...
//         <div className="mx-[20px] lg:mx-[138px] mt-[40px] lg:mt-[80px]">
//           <Carousel autoplay className='w-full h-154px'>
//             {[PumaLogo, UnderArmourLogo, NikeLogo, AdidasLogo, ReebokLogo].map((logo, index) => (
//               <div key={index} className="flex justify-center items-center h-48 bg-white rounded-lg p-4">
//                 <Image src={logo} alt={`${logo} Logo`} width={100} height={100} />
//               </div>
//             ))}
//           </Carousel>
//         </div>
